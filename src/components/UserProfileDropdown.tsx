...
import { LogOut, Settings, Edit, Plus, Users } from 'lucide-react';
...
export const UserProfileDropdown: React.FC<UserProfileDropdownProps> = ({
  ...
  // Use real user data from useAuth hook
  const userData = user || {
    name: 'Sana Afzal',
  ...
  return <div className="user-profile-dropdown absolute right-0 top-12 w-72 bg-white rounded-lg shadow-lg border border-gray-200 z-50 overflow-hidden">
      ...
      <div className="flex flex-col items-center p-6 border-b border-gray-100">
        <div className="relative mb-3">
          <img src={userData.avatar || "/image.png"} alt={userData.name} className="w-20 h-20 rounded-full object-cover" />
      ...
      <div className="border-t border-gray-100 py-2">
        <button
          className="w-full flex items-center px-4 py-3 text-red-500 hover:bg-red-50 transition-colors disabled:opacity-70"
